            ...
            <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-md border-b border-slate-100">
                <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        <Link to="/signin" className="text-sm font-bold text-slate-600 hover:text-teal-600 transition-colors">Sign In</Link>
                        <Link to="/signup" className="px-5 py-2.5 bg-teal-600 text-white rounded-xl text-sm font-bold hover:bg-teal-700 transition-all shadow-lg shadow-teal-100">Start Free</Link>
                    </div>
                </div>
            </nav>
            ...
            <main>
                ...
                <section id="hero" className="relative pt-32 pb-32 overflow-hidden">
                    ...
                    <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                            <Link to="/signup" className="w-full sm:w-auto px-8 py-4 bg-teal-600 text-white rounded-xl font-bold text-lg hover:bg-teal-700 transition-all shadow-xl shadow-teal-100 flex items-center justify-center">Start Free Trial</Link>
                            <Link to="/signup" className="w-full sm:w-auto px-8 py-4 bg-white text-slate-900 border border-slate-200 rounded-xl font-bold text-lg hover:bg-slate-50 transition-all flex items-center justify-center">Request Demo</Link>
                        </div>
                        {/*  Dashboard Preview  */}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
                            ...
                            <div className="p-8 bg-slate-800/50 rounded-3xl border border-slate-700/50 flex flex-col md:flex-row items-center gap-8">
                                <div className="w-full md:w-1/2">
                                    ...
                                    <Link to="/signup" className="inline-flex items-center gap-2 text-teal-400 font-bold hover:gap-3 transition-all">Learn more <iconify-icon icon="lucide:arrow-right"></iconify-icon></Link>
                                </div>
                            ...
                            <div className="p-8 bg-slate-800/50 rounded-3xl border border-slate-700/50 flex flex-col md:flex-row items-center gap-8">
                                <div className="w-full md:w-1/2">
                                    ...
                                    <Link to="/signup" className="inline-flex items-center gap-2 text-teal-400 font-bold hover:gap-3 transition-all">View details <iconify-icon icon="lucide:arrow-right"></iconify-icon></Link>
                                </div>
                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                            ...
                            <div className="space-y-6">
                                ...
                                <Link to="/signup" className="inline-flex items-center gap-2 text-teal-600 font-bold hover:gap-3 transition-all text-lg">Watch the full demo <iconify-icon icon="lucide:play-circle"></iconify-icon></Link>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section id="integrations" className="py-32 bg-slate-50">
                    <div className="max-w-7xl mx-auto px-6">
                        ...
                        <div className="mt-12 text-center">
                            <Link to="/signup" className="inline-flex items-center gap-2 text-teal-600 font-bold hover:gap-3 transition-all">Explore all 500+ integrations <iconify-icon icon="lucide:arrow-right"></iconify-icon></Link>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-20">
                            <div>
                                ...
                                <div className="mt-12">
                                    <Link to="/signup" className="px-8 py-4 bg-teal-600 text-white rounded-xl font-bold text-lg hover:bg-teal-700 transition-all shadow-xl shadow-teal-100 flex items-center justify-center w-fit">View Analytics Demo</Link>
                                </div>
                            </div>
                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            <div className="p-10 rounded-3xl border border-slate-200 hover:shadow-xl transition-all">
                                ...
                                <Link to="/signup" className="w-full inline-flex items-center justify-center py-4 border border-slate-900 rounded-xl font-bold hover:bg-slate-900 hover:text-white transition-all">Get Started</Link>
                            </div>
                            {/*  Growth  */}
                            <div className="p-10 rounded-3xl border-2 border-teal-600 shadow-2xl shadow-teal-100 relative bg-white scale-105">
                                ...
                                <Link to="/signup" className="w-full inline-flex items-center justify-center py-4 bg-teal-600 text-white rounded-xl font-bold shadow-lg shadow-teal-200 hover:bg-teal-700 transition-all">Select Plan</Link>
                            </div>
                            {/*  Enterprise  */}
                            <div className="p-10 rounded-3xl border border-slate-200 hover:shadow-xl transition-all">
                                ...
                                <Link to="/signup" className="w-full inline-flex items-center justify-center py-4 border border-slate-900 rounded-xl font-bold hover:bg-slate-900 hover:text-white transition-all">Contact Sales</Link>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section id="cta" className="py-20 bg-teal-600 relative overflow-hidden">
                    ...
                    <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                            <Link to="/signup" className="w-full sm:w-auto px-10 py-5 bg-white text-teal-700 rounded-2xl font-bold text-xl hover:bg-teal-50 transition-all shadow-2xl flex items-center justify-center">Sign Up Now</Link>
                            <Link to="/signup" className="w-full sm:w-auto px-10 py-5 border-2 border-white/30 text-white rounded-2xl font-bold text-xl hover:bg-white/10 transition-all flex items-center justify-center">Request a Pricing Quote</Link>
                        </div>
                    </div>
                </section>
            </main>
